...
<?php require_once "../recruit/phpmailer/class.phpmailer.php";?>
                        ...
                        ORDER BY borrow.borrow_id DESC")or die(mysql_error());
						  while($row=mysql_fetch_array($user_query)){
							...
							<tr class="del<?php echo $id ?>">
								...
								<td hidden><?php echo $row['borrow_id']; ?> </td>
								...
								<td><?php echo $row['borrow_status'];?><br>
                                	<?php if($day_left>0){
                                        if(!$mail->send()) 
                                            {
                                                echo "sorry";
                                ...
                                <td width="100">
									<?php  
									if($day_left<0){
										echo $day_left ." days remaining";
										}
									else{
										if($day_left>0){
											echo $day_left ." days left<br>";
