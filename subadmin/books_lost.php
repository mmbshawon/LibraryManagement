      ...
      <div class="container">
        <div class="row">
            ...
            <br>
                ...
                <legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:10px;">Lost Book Table</legend>
                ...
                <div class="panel panel-body">
                        ...
                        <table class="table table-bordered table-striped table-condensed table-responsive table-hover" id="example">
                            ...
                            <tbody>
                                <?php  $user_query=mysql_query("select * from booklist where status = 'Lost'")or die(mysql_error());
