...
<?php include ('../recruit/includes/subadmin_menu.php');?>
      ...
      <div class="container">
        ...
        <div class="col-md-12 well">
            <legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:5px;">Borrow Book Table</legend>
                        ...
                        <div class="control-group">
                        	...
                        	<div>
                              <select name="member_id" class="chzn-select" style="width:100%;" required>
								...
								$user_query=mysql_query("select * from member where member_id='$member_id'")or die(mysql_error());
                                ...
                                while ($row=mysql_fetch_array($user_query)){ ?>
                                <option disabled value="<?php echo $row['member_id']; ?>"><?php echo $row['firstname']." ".$row['lastname']; ?></option>
                                <?php } ?>
                              </select>
                            </div>
            			</div>
                	...
                	<div class="panel panel-body"> 
                        <table class="table table-hover table-striped table-bordered table-condensed table-responsive" id="example">
            				...
            				<tbody>
								...
								$user_query=mysql_query("select * from booklist where book_id='$book_id'")or die(mysql_error());
            					while($row=mysql_fetch_array($user_query)){
            					$id=$row['book_id'];
