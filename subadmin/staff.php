        ...
        <div class="container">
        	...
        	<div class="col-md-12" id="subadmin-page-body">
            	...
            	<div class="col-md-12 well">
                	<legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:5px;">Staff List</legend>
                </div>
                <div class="panel panel-default">
                    ...
                    <table class="table table-bordered table-striped table-condensed table-responsive table-hover" id="example">
                        ...
                        <tbody>
                            <?php              
                                $user_query = mysql_query("select * from member where type ='Staff'")or die(mysql_error());
