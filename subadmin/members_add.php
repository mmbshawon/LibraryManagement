...
<?php include ('../recruit/includes/subadmin_menu.php');?>
    ...
    <div class="container">
		...
		<div class="col-md-12" id="subadmin-page-body">		
            <br>
            <form role="form" class="well form-horizontal" method="post" action="members_add.php">
				<fieldset>
				<legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:10px;">Add Member Details</legend>
