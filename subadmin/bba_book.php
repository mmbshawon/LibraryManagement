...
<?php include ('../recruit/includes/subadmin_menu.php');?>
      ...
      <div class="container">
        ...
        <div class="col-md-12 well">
            <legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:5px;">BBA Department Book Table</legend>
                  ...
                  <div class="panel panel-default">
                    <div class="panel panel-body"> 
                        <table class="table table-hover table-striped table-bordered table-condensed table-responsive" id="example">
                            ...
                            <tbody>
                                <?php  $user_query=mysql_query("select * from booklist where department='BBA'")or die(mysql_error());
