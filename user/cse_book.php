...
<?php include ('../recruit/includes/user_menu.php');?>
      ...
      <div class="container">
        ...
        <div class="col-md-12 well">
            <legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:5px;">CSE Department Book Table</legend>
                  ...
                  <div class="panel panel-default">
                    <div class="panel panel-body table-responsive"> 
                        <table class="table table-hover table-striped table-bordered table-condensed" id="example">
                            ...
                            <tbody>
                                <?php  $user_query=mysql_query("select * from booklist where department='CSE'")or die(mysql_error());
