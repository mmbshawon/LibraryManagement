        	...
        	<div class="container">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav nav-pills">
                        ...
                        <li><a href="admin_all.php">Admin</a></li>
                        <li><a href="subadmin_all.php">SubAdmin</a></li>
                    ...
                    <ul class="nav navbar-nav nav-pills navbar-right">
                        ...
                        <li><a href="index_admin.php"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp;Sign In</a></li>
					   <?php }?>
                    	<?php if(isset($_SESSION["admin_id"])){?> 
