...
<?php
  ...
  mysql_query ("INSERT INTO subadmin(sub_admin_name, password, firstname, lastname, gender, address, contract, email, status) values ('$sub_admin_name', '$password', '$firstname', '$lastname', '$gender', '$address', '$contract', '$email', '$status')")or die(mysql_error());
...
<div class="container">
    <div class="row">
            ...
            <form role="form" class="well form-horizontal" method="post" action="admin_add.php">
				        <fieldset>
				            <legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:10px;">Add SubAdmin Details</legend>
                    <div class="form-group">
                        <label class="col-md-4 control-label">SubAdmin Name</label>  
                        <div class="col-md-4 inputGroupContainer">
                          <div class="input-group">
                              <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                              <input  name="sub_admin_name" placeholder="SubAdmin Name" class="form-control"  type="text" required />
                          </div>
                        </div>
                    </div>
