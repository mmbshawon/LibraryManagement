...
<?php 
  ...
  $id =($_POST['id']);
  $sub_admin_name = ($_POST['sub_admin_name']);
  ...
  mysql_query("update subadmin set sub_admin_name = '$sub_admin_name',password = '$password', firstname = '$firstname',lastname = '$lastname',gender = '$gender',address = '$address',contract = '$contract',email = '$email',status = '$status'	where sub_admin_id='$id'")or die(mysql_error());
...
<?php $get_id = $_GET['id']; ?>
<?php 
	$query=mysql_query("select * from subadmin where sub_admin_id='$get_id'")or die(mysql_error());
...
<div class="container">
    <div class="row">
            ...
            <br>
            <form role="form" class="well form-horizontal" method="post" action="subadmin_edit.php">
				        <fieldset>
				            <legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:10px;">Edit SubAdmin Details</legend>
                    <div class="form-group">
                        <label class="col-md-4 control-label">SubAdmin Name</label>  
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input  name="sub_admin_name" class="form-control"  type="text" value="<?php echo $row['sub_admin_name']?>" required>
                                <input class="form-control" type="hidden" name="id" value="<?php echo $get_id;  ?>" placeholder="SubAdmin Name" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <a href="subadmin_all.php" class="btn btn-danger" role="button">Cancel&nbsp;<i class="fa fa-times-circle" aria-hidden="true"></i></a>
