    ...
    <div class="row">
        <div class="col-md-12" id="subadmin-page-body">
            ...
            <div class="well col-md-12">
                <legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:10px;">Order Book Table</legend>
                <div class="panel panel-default">
                    <div class="panel panel-body">
                        <table class="table table-bordered table-striped table-condensed table-responsive table-hover" id="example">
                            ...
                            <tbody>
                                <?php  $user_query=mysql_query("select * from booklist where status = 'Order'")or die(mysql_error());
