	...
	<div class="row">
	   <div class="col-md-12" id="admin-page-body">
        	...
        	<div class="col-md-12 well">
            	<legend class="text-center" style="background:#FFF; color:#000; padding:10px; border-radius:5px;">Main Admin list</legend>
            	<div class="col-md-4">
                    <p><a href="admin_add.php" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Add New Admin</a></p>
                </div>
            ...
            <div class="panel panel-default">
        	    <div class="panel panel-body"> 
                    <table class="table table-bordered table-striped table-condensed table-responsive table-hover" id="example">
			            ...
			            <tbody>
            				<?php  $user_query=mysql_query("select * from admin")or die(mysql_error());
            					...
            					<tr class="del<?php echo $id ?>">
            						...
            						<td width="100">
            							<a rel="tooltip"  title="Delete" id="<?php echo $id; ?>" href="#admin_delete<?php echo $id; ?>" data-toggle="modal"    class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
            									<?php include('admin_delete_modal.php'); ?>
            							<a  rel="tooltip"  title="Edit" id="e<?php echo $id; ?>" href="admin_edit.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="fa fa-pencil" aria-hidden="true"></i></a>
            					   </td>
            					</tr>
                            <?php }?>
                        </tbody>
